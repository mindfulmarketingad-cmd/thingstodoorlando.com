...
export const staticPages = [
  ...
  { href: "/author", title: "Our Authors", text: "authors writers editors team" },
  { href: "/events", title: "Orlando Events Calendar", text: "events calendar festival festivals month concerts sports games markets" },
  { href: "/events/this-weekend", title: "Things To Do In Orlando This Weekend", text: "this weekend events today tonight saturday sunday" },
  { href: "/events/halloween-in-orlando", title: "Halloween in Orlando", text: "halloween october horror nights not so scary party haunted ghost" },
  { href: "/events/christmas-in-orlando", title: "Christmas in Orlando", text: "christmas holiday holidays december lights santa new years" },
